# Cupones — Resumen del microservicio

## Propósito

administra los datos y la lógica del dominio de Cupones del caso caso05 (FoodGo).

## Contexto

- **Caso**: caso05 — FoodGo (Delivery de comida)
- **Microservicio**: cupones
